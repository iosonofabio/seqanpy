...
int align_semi_global(std::string seq1, std::string seq2, std::string* ali1, std::string* ali2, int band,
	...
	if(band >= 0)
		score = globalAlignment(ali,
					Score<int,Simple>(score_match, score_mismatch,score_gapext, score_gapopen),
